...
import SearchIcon from './icons/virussearch';
const Sidebar = () => (
    <div className={styles.sidebar}>
        <div className={styles.nav}>
            <nav className={styles.navtop}>
                <NavLink to="/" className={({ isActive }) => isActive ? `${styles.item} ${styles.active}` : styles.item}><SearchIcon/><span>Проверка</span></NavLink>
